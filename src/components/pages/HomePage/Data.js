...
export const homeObjOne = {
    ...
    lightTextDesc: true,
    topLine: '',
    headline: 'Pixel pusher & Crafty Coder',
    description:
    ...
    logoImg: 'https://ko2m0.github.io/rocks/images/kozmo_Logo4ws_1.svg',
    homeSocialIcons: true,
  };
  
  export const twoObjOne = {
    lightBg: false,
    lightText: true,
    lightTextDesc: true,
    topLine: 'About Me',
    headline: '',
    description: 'I´m an Inventive and resourceful Designer/Developer based in Morelia, Mexico currently working for an international Avocado exporter.',
  ...
  export const latestprojectsWS = {
    lightBg: false,
    imgStart: 'start',
    Skill: 'Web Design UX/UI',
    projectImg: 'https://casadelaguacate.com/sitioweb2/media/img/recipe1.png',
    imgAlt: 'alt1',
    projectTitle: 'Web Design title 1',
    projectDescription: 'Web Design description 1', 
    projectLink: 'a link here',
  }

  export const skillsGD = {
    lightBg: false,
    imgStart: '',
    topLine: 'Skills',
    headline: 'Graphic Design',
  ...
  export const latestprojectsGD = {
    ...
    projectImg: 'https://casadelaguacate.com/sitioweb2/media/img/recipe1.png',
    imgAlt: 'alt1',
    projectTitle: 'Graphic Design title 1',
    projectDescription: 'Graphic Design description 1', 
    projectLink: 'a link here',
  }


  export const skillsWDev = {
    lightBg: false,
    imgStart: 'start',
    topLine: 'Skills',
    headline: 'Web Dev',
    ...
    img: 'https://ko2m0.github.io/rocks/images/svg-6.svg',
  }
  ...
  export const latestprojectsMkt = {
    ...
    projectImg: 'https://casadelaguacate.com/sitioweb2/media/img/recipe1.png',
    imgAlt: 'alt1',
    projectTitle: 'Marketing title 1',
    projectDescription: 'Marketing description 1', 
    projectLink: 'a link here',
  }
  ...
  export const latestprojectsCreative = {
    ...
    projectImg: 'https://casadelaguacate.com/sitioweb2/media/img/recipe1.png',
    imgAlt: 'alt1',
    projectTitle: 'Creative title 1',
    projectDescription: 'Creative description 1', 
    projectLink: 'a link here',
  }

  export const skillsMm = {
    lightBg: false,
    imgStart: '',
    topLine: 'Skills',
    headline: 'Multimedia',
  ...
  export const latestprojectsMm = {
    ...
    projectImg: 'https://casadelaguacate.com/sitioweb2/media/img/recipe1.png',
    imgAlt: 'alt1',
    projectTitle: 'Multimedia title 1',
    projectDescription: 'Multimedia description 1', 
    projectLink: 'a link here',
  }